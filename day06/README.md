...
The notebook ( plots roofline charts for H100, A100, RTX 4090, and DGX Spark, sweeps batch sizes to find the memory-to-compute crossover, and benchmarks real matrix multiplies to verify where theory meets measurement.
